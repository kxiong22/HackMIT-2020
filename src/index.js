        ...
        return (
            <div>
                <Navbar className="nav-bar" expand="lg">
                    ...
                    <Navbar.Brand style={{fontSize: '20px'}}>NutriChef</Navbar.Brand>
                    <Navbar.Toggle aria-controls="basic-navbar-nav" />
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto">
                            <Nav.Link onClick={() => this.changeVisibility('showHome')}>Home</Nav.Link>
                            <Nav.Link onClick={() => this.changeVisibility('showProgress')}>Daily Summary</Nav.Link>
                            <Nav.Link onClick={() => this.changeVisibility('showFarms')}>Local Farmer's Markets</Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                </Navbar>
